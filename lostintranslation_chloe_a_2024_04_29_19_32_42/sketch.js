...
function draw() {
  //color the back ground white//
  background(255,255,255);
  
  //makes squares with grey strokes of weight 4//
  stroke(197,197,197)
  strokeWeight(4);
  
//makes all positions of light blue squares, in the order from left to right, top to bottem//
  fill(46,237,240)
  rect(180,100,40,40)
  rect(220,100,40,40)
